from evaluation.augmentations import apply_augmentations, parse_augmentations, Basepoint, Scale
from functools import partial
from typing import Tuple, Optional
from evaluation.utils import to_numpy
import math
...
import evaluation.eval_helper as eval
...
class CrossCorrelationMetric(Metric):
    ...
    def measure(self,data,lags,dim=(0, 1)):
        ...
        # print('transdatashape',self.transform(data).shape)
